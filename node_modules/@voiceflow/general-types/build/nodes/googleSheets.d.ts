...
export declare type GoogleSheetsValueLabel = {
    value: number;
    label: string;
};
export declare type GoogleSheetsMapping = {
    arg1: GoogleSheetsValueLabel;
    arg2: string;
};
export declare type GoogleSheetsSpreadsheet = {
    value: string;
    label: string;
};
...
export declare type Step = DefaultStep<NodeType.GOOGLE_SHEETS, StepData>;
