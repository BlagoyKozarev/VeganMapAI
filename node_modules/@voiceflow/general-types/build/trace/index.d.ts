...
export declare type DebugTrace = TraceFrame<TraceType.DEBUG, {
    message: string;
}>;
export declare type BlockTrace = TraceFrame<TraceType.BLOCK, {
    blockID: string;
}>;
export declare type GeneralTrace = ExitTrace | SpeakTrace | ChoiceTrace | FlowTrace | StreamTrace | BlockTrace | DebugTrace | VisualTrace;
