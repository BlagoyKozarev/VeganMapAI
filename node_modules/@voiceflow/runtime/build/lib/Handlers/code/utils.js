...
exports.vmExecute = (data, safe = true) => {
    const vm = new vm2_1.VM({
        timeout: 1000,
        sandbox: Object.assign(Object.assign({ Promise: null }, lodash_1.default.cloneDeep(data.variables)), { requireFromUrl: sync_1.default }),
    });
    const clearContext = `
          (function() {
            Function = undefined;
