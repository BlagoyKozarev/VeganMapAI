...
const CodeHandler = ({ endpoint } = {}) => ({
    ...
    handle: async (node, runtime, variables) => {
        ...
        try {
            ...
            const data = endpoint ? (await axios_1.default.post(endpoint, reqData)).data : utils_1.vmExecute(reqData);
            ...
            runtime.trace.debug(`unable to resolve code  \n\`${safe_json_stringify_1.default((_b = error.response) === null || _b === void 0 ? void 0 : _b.data)}\``);
